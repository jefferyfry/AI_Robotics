...
def doit(initial_pos, move1, move2, Z0, Z1, Z2):
    omega = [[0 for row in range(4)] for col in range(4)]
    omega[0][0] = 1

    xi = [[0 for row in range(1)] for col in range(4)]
    xi[0][0] = initial_pos
    ...
    for index in range(len(moves)):
        for row in range(index,index+2):
            for col in range(index,index+2):
                if row == index:
                    if col == index:
                        omega[row][col]+=1
                    else:
                ...
                if row==index and col == index:
                    xi[row][0]-=moves[index]
                elif row==(index+1) and col == index:
                    xi[row][0]+=moves[index]

    #process the landmark(col,row=3)
    landmark = [Z0,Z1,Z2] #have high confidence in Z2, so process by factor of 5
        ...
        for row in [index,3]:
            for col in [index,3]:
                if index == 2:
                    ...
                    if row==index and col == index:
                        xi[row][0]-=landmark[index]*5
                    elif row==3 and col == index:
                        xi[row][0]+=landmark[index]*5
                else:
                    if row == index:
                        if col == index:
